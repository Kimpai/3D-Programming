...
bool DeferredBuffersClass::Initialize(ID3D11Device* device, int textureWidth, int textureHeight, float screenDepth, float screenNear)
{
	...
	//Initialize the render target texture desc
	ZeroMemory(&textureDesc, sizeof(textureDesc));

	//Setup the render target texture desc
	...
	//Setup the desc of the render target view
	...
	//Setup the desc of the shader resource view
	...
	//Setup the desc of the depth buffer
	...
	//Initialize the depth stencil view desc
...
void DeferredBuffersClass::SetRenderTarget(ID3D11DeviceContext* deviceContext)
{
